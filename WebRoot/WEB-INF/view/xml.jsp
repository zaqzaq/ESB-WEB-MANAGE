...
<ul class="nav nav-tabs">
  <li class="active"><a href="#xmlContent" data-toggle="tab">XML内容</a></li>
...
<div class="row">
    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane fade in col-md-5" id="info">
      ...
      <div class="tab-pane active  col-md-12" id="xmlContent">
          <div class="form-group">
