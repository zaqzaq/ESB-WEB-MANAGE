...
public class EncryptUtil {
	 ...
	 * @throws Exception 
	 */
	public static synchronized String encryptSha256(String inputStr) throws Exception {
		try {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(encryptSha256(z));
		System.out.println(encryptMd5(z));
		System.out.println(encryptSha256(encryptMd5(z)));
	}
